    ...
    <div className="min-h-screen w-full bg-white overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 h-screen">
        ...
        <div className="flex flex-col justify-center items-center px-6 md:px-12 bg-white">
          ...
          {/* Wrapper to constrain the form width to exactly 434px */}
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <button type="button" className="text-xs font-bold text-[#0A2A99] hover:underline">
                    Forgot password?
                  </button>
                </div>
                <input 
        ...
        {/* RIGHT SIDE: FULL DISPLAY IMAGE (50%) */}
