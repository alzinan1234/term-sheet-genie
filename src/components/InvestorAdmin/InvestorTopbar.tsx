...
interface InvestorTopbarProps {
  onBellClick?: () => void; // Optional function type since usage is commented out
}

export default function InvestorTopbar({ onBellClick }: InvestorTopbarProps) {
  ...
  return (
    <header className="flex items-center justify-end bg-white p-5 border-b border-[#D6D6D6]">
      <div className="flex items-center gap-6">
        ...
        >
          ...
          <span className="text-[#FFFF] bg-[#B92921] rounded-full px-3 py-1 text-sm">
            8
          </span>
        </div> */}
        <div
