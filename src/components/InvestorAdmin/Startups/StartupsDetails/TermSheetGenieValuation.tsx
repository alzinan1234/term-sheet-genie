          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
            <div className="grid grid-cols-2 gap-20">
              ...
              <div className="space-y-3">
                <h3 className="text-[14px] font-semibold text-black mb-4">Round C</h3>
              ...
              <div className="space-y-3">
                <h3 className="text-[14px] font-semibold text-black mb-4">XYZ Growth Fund</h3>
                ...
                <div className="flex justify-between text-[12px] pt-2">
                  <span className="text-gray-800 font-bold">Breakeven Valuation</span>
                  <span className="font-bold text-black">$53.09M</span>
                </div>
              </div>
            </div>
          </div>
