...
import SimulationResultsWrapper from "../../InvestorOverview/Simulationresultswrapper";
...
export default function SimulationSectionCard({ onSimulationOpen, onSimulationClose }: SimulationSectionProps) {
