    ...
    <div className="min-h-screen flex items-center justify-center">
      ...
      <div className="w-full h-full flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-[45%] lg:w-[40%] flex flex-col justify-center px-6 md:px-12 lg:px-20 py-12 rounded-[32px]">
          ...
          {/* Header Text */}
          <div className="mb-8">
            <h1 className="text-[32px] font-bold text-[#1A1C1E] mb-2 leading-tight">Get Started Now</h1>
            <p className="text-gray-500 text-sm">Sign up today to make smarter deals!</p>
          </div>
